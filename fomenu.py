...
class Game:
    ...
    jatek = Button(text="Play", fg="black", width=40, height=6, bd=0, bg="#f1f5ff", cursor="hand2", command=lambda: btn_click(0))
    jatek.grid(row=0, column=0, padx=1265, pady=20)

    credits = Button(text="Credits", fg="black", width=40, height=6, bd=0, bg="#f1f5ff", cursor="hand2", command=lambda: btn_click(0))
    credits.grid(row=1, column=400, padx=1265, pady=20)

    options = Button(text="Options", fg="black", width=40, height=6, bd=0, bg="#f1f5ff", cursor="hand2", command=lambda: btn_click(0))
    options.grid(row=2, column=0, padx=1265, pady=20)

    exit = Button(text='Exit', fg="Red", width=40, height=6, bd=0, bg="#f1f5ff", cursor="hand2", command=root.destroy)
