...
class Game:
    ...
    jatek.grid(row=0, column=0, columnspan=2, padx=1, pady=1)

    credits = Button(text="Credits", fg="black", width=20, height=5, bd=0, bg="#fff", cursor="hand2", command=lambda: btn_click(0))
    credits.grid(row=1, column=0, columnspan=2, padx=1, pady=1)

    options = Button(text="Options", fg="black", width=20, height=5, bd=0, bg="#fff", cursor="hand2", command=lambda: btn_click(0))
    options.grid(row=2, column=0, columnspan=2, padx=1, pady=1)

    exit = Button(root, text='Exit', fg="Red", width=20, height=5, bd=0, bg="#fff", cursor="hand2", command=root.destroy)
    exit.grid(row=3, column=0, columnspan=2, padx=1, pady=1)
    root.mainloop()
